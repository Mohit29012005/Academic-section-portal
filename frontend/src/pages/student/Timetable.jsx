        ...
        <StudentLayout>
            <div className="relative">
                ...
                <div className="animate-fade-in relative z-10">
                    ...
                    <div className="bg-black/40 p-4 border-l-4 border-[var(--gu-gold)] mb-6 flex items-start gap-3 rounded-md">
                    ...
                    {loading ? (
                        ...
                        <>
                                                ...
                                                {days.map(day => {
                                                        ...
                                                        return (
                                                            <td key={day} className="p-3 text-center bg-gradient-to-r from-[rgba(212,175,55,0.03)] to-transparent border-r border-[var(--gu-gold)]/10 last:border-0">
                                                                <div className="flex flex-col items-center">
                                                                    <span className="text-[var(--gu-gold)]/40 text-[10px] uppercase font-black tracking-[0.3em] opacity-30">🍽️ LUNCH</span>
                                                    ...
                                                    return (
                                                        <td key={day} className="p-1.5 border-r border-[var(--gu-gold)]/10 last:border-0">
                                                            {data ? (
                                                                <div className="bg-gradient-to-br from-black/50 to-black/20 border-l-3 border-l-[var(--gu-gold)] border border-white/5 p-2.5 rounded-md hover:border-[var(--gu-gold)]/30 transition-all duration-200 shadow-md" style={{borderLeftWidth: '3px'}}>
                            ...
                            {Object.keys(subjectLegend).length > 0 && (
                                <div className="mt-6 bg-black/30 border border-[var(--gu-gold)]/20 rounded-md p-5 backdrop-blur-sm">
