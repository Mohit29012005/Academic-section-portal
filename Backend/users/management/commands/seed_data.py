...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write("  Student: 23032432001@gnu.ac.in / amaterasu123")
        self.stdout.write("  Faculty: pooja.pancholi@gnu.ac.in / amaterasu123")
        self.stdout.write("  Admin:   admin@gnu.ac.in / amaterasu123\n")
    ...
    def create_students(self, courses):
        ...
        # Enrollment prefix by course: BCA=23032431, MCA=23032432, BSC-IT=23032433,
        # BTECH-CSE=23032434, BSC-AIML=23032435, MSC-CYBER=23032436, BTECH-IT=23032437
        data = [
            ("23032432001", "Arjun Kumar", "MCA", 2, 8.5, "9876543001"),
            ("23032432002", "Priya Sharma", "MCA", 2, 9.2, "9876543002"),
            ("23032431001", "Rahul Singh", "BCA", 4, 7.8, "9876543003"),
            ("23032433001", "Sneha Patel", "BSC-IT", 3, 8.1, "9876543004"),
            ("23032434001", "Amit Verma", "BTECH-CSE", 5, 8.9, "9876543005"),
            ("23032432003", "Neha Gupta", "MCA", 1, 8.0, "9876543006"),
            ("23032431002", "Vikram Rao", "BCA", 3, 7.5, "9876543007"),
            ("23032435001", "Anjali Shah", "BSC-AIML", 2, 8.7, "9876543008"),
            ("23032437001", "Karan Mehta", "BTECH-IT", 4, 8.3, "9876543009"),
            ("23032436001", "Divya Joshi", "MSC-CYBER", 2, 9.0, "9876543010"),
        ]
        students = []
        for enr, name, course_code, sem, cgpa, phone in data:
            course = courses[course_code]
            email = f"{enr}@gnu.ac.in"
            user = User.objects.create_user(
                email=email, password="amaterasu123", role="student"
            )
    ...
    def create_faculty(self, subjects):
        ...
        for emp_id, name, email, dept, subj_codes, phone in data:
            user = User.objects.create_user(
                email=email, password="amaterasu123", role="faculty"
            )
    ...
    def create_semester_results(self, students):
        ...
        arjun = students[0]
        SemesterResult.objects.filter(student=arjun, semester=1).update(
            sgpa=8.2, status="completed", year=2023
        )
        SemesterResult.objects.filter(student=arjun, semester=2).update(
            sgpa=8.8, status="completed", year=2024
        )
        for sem in range(3, arjun.total_semesters + 1):
            SemesterResult.objects.filter(student=arjun, semester=sem).update(
                sgpa=None, status="remaining", year=None
            )
    ...
    def create_exams(self, subjects, courses, faculty_list):
        ...
        data = [
            (
                "Mid-Term Examination - Data Structures",
                "CS101",
                "MCA",
                0,
                time(10, 0),
            ...
            (
                "End-Term Examination - Algorithms",
                "CS102",
                "MCA",
                0,
                time(14, 0),
            ...
            (
                "Mid-Term Examination - Database Systems",
                "CS201",
                "MCA",
                1,
                time(14, 0),
            ...
            (
                "End-Term Examination - Web Development",
                "CS202",
                "MCA",
                1,
                time(10, 0),
            ...
            (
                "Mid-Term Examination - Operating Systems",
                "CS301",
                "BCA",
                2,
                time(11, 0),
        ...
        questions_bank = {
            0: [  # Data Structures exam
                ...
                (
                    ...
                    ["Binary tree", "Self-balancing BST", "Heap", "Trie"],
                    "Self-balancing BST",
                ),
                (
                    "Queue follows which principle?",
                    ["LIFO", "FIFO", "LILO", "Random"],
                    "FIFO",
                ),
                (
            ...
            1: [  # Algorithms exam
                ...
                (
                    ...
                    ["Sorting", "Shortest path", "MST", "Searching"],
                    "Shortest path",
                ),
                (
                ...
                (
                    ...
                    ["Shortest path", "MST", "Maximum flow", "Topological sort"],
                    "MST",
                ),
                (
    ...
    def create_assignments(self, subjects, faculty_list):
        ...
        data = [
            (
                ...
                "Compare their time complexities with empirical data.",
                20,
            ...
            (
                ...
                "Include ER diagram, normalization, and SQL queries.",
                25,
            ...
            (
                ...
                "authentication, CRUD operations, and responsive design.",
                30,
            ...
            (
                ...
                "Implement any two and analyze their performance.",
                20,
            ...
            (
                ...
                "document the protocol headers and data flow.",
                25,
    ...
    def create_assignment_submissions(self, assignments, students):
        ...
        submissions_data = [
            (
                ...
                "accepted",
                18,
                "Excellent implementation with proper analysis.",
            ),
            (
                0,
                1,
                ...
                "accepted",
                20,
                "Outstanding work! All algorithms implemented correctly.",
            ),
            (
                2,
                2,
                ...
                "rejected",
                None,
                "High plagiarism detected. Please resubmit original work.",
            ),
        ]
        count = 0
