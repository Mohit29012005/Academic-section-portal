...
class Command(BaseCommand):
    ...
    def create_students(self, courses):
        ...
        for enr, name, course_code, sem, cgpa, phone in data:
            ...
            user = User.objects.create_user(email=email, password='amaterasu123', role='student')
    ...
    def create_faculty(self, subjects):
        ...
        data = [
            ('EMP001', 'Dr. Pooja Pancholi', 'pooja.pancholi@gnu.ac.in', 'Computer Applications',
             ['CS101', 'CS102'], '9876543101'),
            ('EMP002', 'Dr. Rajesh Kumar', 'rajesh.kumar@gnu.ac.in', 'Information Technology',
             ['CS201', 'CS202'], '9876543102'),
            ('EMP003', 'Dr. Anjali Mehta', 'anjali.mehta@gnu.ac.in', 'Computer Science',
             ['CS301', 'CS302'], '9876543103'),
            ('EMP004', 'Dr. Suresh Patel', 'suresh.patel@gnu.ac.in', 'Cyber Security',
             ['CY401', 'CY402'], '9876543104'),
            ('EMP005', 'Dr. Priya Sharma', 'priya.sharma@gnu.ac.in', 'AI & ML',
             ['AI501', 'AI502'], '9876543105'),
        ]
        faculty_list = []
        for emp_id, name, email, dept, subj_codes, phone in data:
            user = User.objects.create_user(email=email, password='amaterasu123', role='faculty')
    ...
    def create_admin(self):
        ...
        user = User.objects.create_user(
            email='admin@gnu.ac.in', password='amaterasu123', role='admin',
            is_staff=True, is_superuser=True,
        )
        admin = AdminModel.objects.create(
            user=user, admin_id='ADM001', name='Admin User',
            email='admin@gnu.ac.in', phone='9876543200',
        )
