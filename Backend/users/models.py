...
class Student(models.Model):
    ...
    course = models.ForeignKey(
        'academics.Course', on_delete=models.SET_NULL, null=True,
        related_name='students', db_column='course_id'
    )
    ...
    is_face_registered = models.BooleanField(default=False,
                                              help_text='True when student has completed face onboarding')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
