...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-ampics-dev-key-change-in-production-2024')
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        ...
        'attendance_ai.permissions.FaceRegistrationRequired',
    ],
...
for directory in ['uploads', 'pyqs', 'exam_materials', 'assignments',
                  'face_encodings', 'attendance_snapshots', 'reports']:
